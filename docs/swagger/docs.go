...
const docTemplate = `{
    ...
    "definitions": {
        ...
        "models.SysApiSyncRequest": {
            ...
            "properties": {
                "groupByPlugin": {
                    "description": "GroupByPlugin 插件路由分组是否带 plugins/ 前缀，默认 false（Go bool 零值；前端需显式传 true）",
                    "type": "boolean"
                },
                "includePlugins": {
                    "description": "IncludePlugins 是否纳入 /api/plugins/* 路由，默认 false（Go bool 零值；前端需显式传 true）",
                    "type": "boolean"
                },
                "overwrite": {
